...
const client = new RestClientV5({
  ...
  testnet: process.env.BYBIT_TESTNET === "true", // true = demo, false = live
});

// Guard log: shows which mode we’re running
console.log(`🔒 Bybit mode: ${process.env.BYBIT_TESTNET === "true" ? "TESTNET (Safe)" : "LIVE (Real Money)"}`);
